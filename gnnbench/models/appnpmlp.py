...
def build_model(graph_adj, node_features, labels, dataset_indices_placeholder,
                ...
                num_layers, num_layers_mlp, hidden_size, dropout_prob, teleport_prob, num_features, random_selection):
    ...
    return APPNPMLP(node_features, graph_adj, labels, dataset_indices_placeholder,
