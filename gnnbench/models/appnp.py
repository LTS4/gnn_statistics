...
class APPNP(GNNModel):
    def __init__(self, features, graph_adj, targets, nodes_to_consider, num_layers,
                 weight_decay, normalize_features, teleport_prob, num_features, random_selection):
    ...
    def _preprocess_features(self, features):
        ...
        for i in range(self.num_layers):
            features = (1 - alpha) * self.graph_adj @ features + alpha * initial_features
...
def build_model(graph_adj, node_features, labels, dataset_indices_placeholder,
                ...
                num_layers, hidden_size, dropout_prob, teleport_prob, num_features, random_selection):
    ...
    return APPNP(node_features, graph_adj, labels, dataset_indices_placeholder,
                 num_layers, weight_decay, normalize_features, teleport_prob, num_features, random_selection)
